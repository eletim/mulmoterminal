...
// (render, media, external). NOT MulmoTerminal state: each is an MCP server registered in
...
const byToolGroup = <T>(value: T): Record<ToolGroup, T> => ({ render: value, media: value, external: value });
