...
| `next-attention` | **Jump to a terminal worth looking at** — awaiting input first, then finished-and-unreviewed, then idle. Skips cells mid-turn. Cycles, and enlarges the one it lands on | no |
