...
| Google account (loopback OAuth) + Calendar status/link routes | `@mulmoclaude/core/google` | `server/backends/google.ts` (shim + `/api/google/*`), `server/cli-google.ts` (#386, #425) |
