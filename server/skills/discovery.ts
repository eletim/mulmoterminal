// Skill discovery shared by settings/tooling surfaces.
//
...
// double-list).
//
// The roots come from backen../backends/collections.ts (`userSkillsDir` / `projectSkillsDir`),
...
import { userSkillsDir, projectSkillsDir } from "../backends/collections.js";
 ...
 * (the ordering capability lists advertise — independent of
